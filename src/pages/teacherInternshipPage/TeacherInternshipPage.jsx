...
import { FaCalendarAlt, FaSearch, FaShieldAlt, FaTimes } from "react-icons/fa";
              ...
              <div className="flex space-x-2">
                ...
                >
                  <Tooltip title="Filter by status">
                    ...
                    >
                      <div className="flex items-center">
                        <FaShieldAlt className="text-pink-500 mr-1.5" />
                ...
                >
                  <Tooltip title="Filter by defense date">
                    ...
                    >
                      <div className="flex items-center">
                        <FaCalendarAlt className="text-pink-500 mr-1.5" />
                        <span className="text-gray-700">
            ...
            <>
              <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 mb-6">
                {filteredInternships.length === 0 ? (
                  ...
                  getCurrentInternships().map((internship) => (
