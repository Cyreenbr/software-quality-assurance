      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center max-w-md p-6 bg-white rounded-lg shadow">
          ...
          <p className="mt-2 text-gray-600">
            {error.message ||
              "Something went wrong while fetching the defense schedule."}
          </p>
          <button
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            {defenses.length} {defenses.length === 1 ? "defense" : "defenses"}{" "}
            scheduled
          </p>
        </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {defenses.map((defense) => (
                  <tr key={defense._id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {defense.pfe?.IsammSupervisor?.firstName || (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {defense.pfe?.IsammSupervisor?.email || (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {defense.presidentId?.firstName || (
                          <span className="text-gray-400">No President</span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {defense.reporterId?.firstName || (
                        ...
                        {defense.date ? (
                          <>
                            ...
                            <div className="text-xs text-gray-500">
                              {new Date(defense.date).toLocaleTimeString([], {
                                hour: "2-digit",
                                minute: "2-digit",
                              })}
                            </div>
        ...
        {defenses.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-gray-500">
              There are currently no defense sessions planned.
            </p>
          </div>
        )}
      </div>
